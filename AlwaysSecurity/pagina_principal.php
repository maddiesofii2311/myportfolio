					...
					<section id="one" class="wrapper style1 special">
						<div class="inner">
							...
							<ul class="actions special" align="center">
								<li><a href="forum_topicos.php" class="button primary">Fórum de Comunicação</a></li>
								<li><a href="zona_jogo.php" class="button primary">Vamos Jogar!</a></li>
					...
					<section id="two" class="wrapper alt style2">
						...
						<section class="spotlight">
							<div class="image"><img src="imagens/estuestac.jpg" height="600px" alt="" /></div><div class="content">
								...
								<p align="center">Aceda a esta página de modo mais rápido clicando no botão apresentado a baixo.</p>
								<ul class="actions special" align="center">
								<li><a href="stuestac_log.php" class="button primary">Estatísticas</a></li>
								</ul>
							</div>
						</section>
					</section>

...
<?php
	...
	$login_desbloq = $_GET['login_desbloq'];

	//echo 'login_desbloq:'.$login_desbloq;	
...
// Function defnition
function funcao_confirm($message)
{   
    
$caminho="adm_area_desbloq_ut.php?login_desbloq=$message";
//echo"caminho:".$caminho;
    ...
    echo "  if (confirm('Deseja mesmo desbloquear ".$message."?')) {";
    echo '    document.location ="'.$caminho.'";';
    echo '  }';
    echo 'else {';

	echo '    document.location = "adm_area_bloqs_bloq_desbloq.php";';
	echo '}';

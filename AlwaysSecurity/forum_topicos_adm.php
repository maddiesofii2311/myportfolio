...
<?php
	...
	echo"<table border= '1' style='width: 60%;'> ";
		...
		echo '<td>Data</td>'; 
		echo '<td>Autor</td>';
		echo "<td style='text-align: center;'>Bloquear</td>";
		echo"</tr>";
...
*/
		...
		else
		{
		  ...
		  onclick="."location.href='adm_area_bloq_ut_forum_confirmacao.php?login_top=".
		  $login_top."';"."> </td>";
	...
	echo"<td colspan='3' align='center'>";
  	echo"<a href='forum_novo_topico_frm_adm.php' class='button primary'>+ criar novo tópico</a>";
	echo"</td>";
	echo"</tr>";

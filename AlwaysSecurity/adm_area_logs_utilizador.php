...
if(!$login_log )
{
	...
	//exit;
	header("Location: adm_area_logs_utilizador_frm.php");
}
	...
	$consulta = "select * From UTILIZADORES, LOGS, OPERACOES
	 WHERE UTILIZADORES.cod_ut= LOGS.cod_ut AND 
	 LOGS.cod_oper= OPERACOES.cod_oper AND
	 UTILIZADORES.login='".$login_log."'
	 ORDER BY dat_oper desc, hrs_oper desc";
	...
	echo"<table border= '1' style='width: 60%;'> ";
		...
		echo"<tr>";
		echo "<td style='color: yellow;'>dat_oper</td>";
		echo "<td style='color: yellow;'>hrs_oper</td>"; 		
	...
	{
	  echo"<tr>";
	  echo"<td>Utilizador não encontrado.</td>";
	  echo"</tr>";
	}
	...
	for($i=0; $i <$nregistos; $i++) 
	{
		...
		$login = $registo['login'];
		$dat_oper = $registo['dat_oper'];
		$hrs_oper = $registo['hrs_oper'];
		$desc_oper = $registo['desc_oper'];
...
echo"</center>";
	...
	echo"<td colspan='3' align='center'>";
  	echo "<a href='adm_area_logs.php'>Voltar</a>";
  	echo"</td>";
	echo"</tr>";
  	echo"</table>";
?>

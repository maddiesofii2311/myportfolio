...
$inserir="INSERT into COMUNICACOES values
('','".$cod_top."','".$cod_ut_resp."','".$dat_com."','".$hrs_com."','".$msg_com."')";
...
if($result!=1)
{
 ...
 echo "</br>";
 echo "<a href='forum_respostas_adm.php'>Voltar</a>";

}
else
{
// se não deu erro então inserir log ins comentário
$dat_oper = $data;
$hrs_oper = $hora;

  $inserir="INSERT into LOGS values
  ('',$cod_ut,'".$dat_ult_login."','".$hrs_ult_login."','".$dat_oper."','".$hrs_oper."',3)";

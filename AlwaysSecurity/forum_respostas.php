...
if($nregistos == 0 && $login_top == $login )
//echo 'permitir eliminar';
{
  ...
  echo"<a href='forum_remover_topico.php?cod_top=".$cod_top."' class='button small' style='align: right;'>remover tópico</a>";
...
// se resposta pertencer à conta logada permitir remover
		if($login_resp == $login)
		{
		  echo"<tr>";
  		  ...
  		  echo"<a href='forum_remover_resposta.php?cod_com=".$cod_com."&cod_top=".$cod_top."' class='button small' style='align: right;'>remover resposta</a>";
...
echo"<form action='forum_nova_resposta.php' method='post'>";
...
<?php
  if($bloq_fom == 'S')
  {
	echo "<input type='button' value='Utilizador Bloqueado' style='color: red;'>";
  }
  else

				...
				<!-- Main -->
					<article id="main">
						<header>
                            ...
                            <p align="center"><a href="expveridicas4_log.php"><b>4º História</b></a></p>
						</header>
						<a name="dest1"></a>
						<section class="wrapper style5">
							<div class="inner">
                            	...
                            	<ul class="actions special" align="center">
                    				<li><a href="expveridicas2_log.php" class="button primary">Anteceder</a></li>
                    				<li><a href="expveridicas4_log.php" class="button primary">Avançar</a></li>
                    			</ul>

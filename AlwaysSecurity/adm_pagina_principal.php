								...
								<li class="special">
									...
									<div id="menu">
										<ul>
											...
											<li><a href="adm_area_jogo.php">Administração do Jogo</a></li>
...
<a href='adm_area_logs.php' class='button primary'>LOGs de Atividades</a>
<a href='adm_area_bloqs.php' class='button primary'>Contas Bloqueadas</a>

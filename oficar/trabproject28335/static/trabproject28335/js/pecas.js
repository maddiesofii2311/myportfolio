document.addEventListener('DOMContentLoaded', function() {
    ...
    function abrirModal(row) {
        ...
        document.getElementById('editDescricao').value = cells[2].textContent;
        document.getElementById('editPreco').value = cells[3].textContent;
        document.getElementById('editStock').value = cells[4].textContent;
    ...
    if (btnGravar) {
        btnGravar.addEventListener('click', function() {
            if (linhaAtual) {
                ...
                cells[2].textContent = document.getElementById('editDescricao').value;
                cells[3].textContent = document.getElementById('editPreco').value;
                cells[4].textContent = document.getElementById('editStock').value;

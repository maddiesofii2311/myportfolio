document.addEventListener('DOMContentLoaded', function() {
    ...
    function abrirModal(row) {
        ...
        document.getElementById('editNIF').value = cells[5].textContent;
    ...
    if (btnGravar) {
        btnGravar.addEventListener('click', function() {
            if (linhaAtual) {
                ...
                cells[4].textContent = document.getElementById('editMorada').value;
                cells[5].textContent = document.getElementById('editNIF').value;
